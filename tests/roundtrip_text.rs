...
use pandoc_notion::p2n::pandoc_text::{ConversionConfig, PandocTextConverter};
...
fn test_pandoc_to_notion_to_pandoc_roundtrip() {
    ...
    let test_cases = vec![
        ...
        // Italic text
        vec![Inline::Emph(vec![
            Inline::Str("Italic".to_string()),
            Inline::Space,
            Inline::Str("text".to_string()),
        ])],
        // Strikethrough text
        vec![Inline::Strikeout(vec![
            Inline::Str("Strikethrough".to_string()),
            Inline::Space,
            Inline::Str("text".to_string()),
        ])],
        // Code text
        ...
        vec![Inline::Span(
            ...
            vec![
                Inline::Str("Underlined".to_string()),
                Inline::Space,
                Inline::Str("text".to_string()),
            ],
        )],
    ...
    for (i, original_pandoc) in test_cases.iter().enumerate() {
        ...
        assert_eq!(
            ...
            "Roundtrip conversion failed for case {}",
            i
        );
    }
}
...
fn test_roundtrip_unicode() {
    let unicode_tests = vec![
        vec![
            Inline::Str("Unicode:".to_string()),
            Inline::Space,
            Inline::Str("你好,".to_string()),
            Inline::Space,
            Inline::Str("こんにちは,".to_string()),
            Inline::Space,
            Inline::Str("안녕하세요".to_string()),
        ],
        vec![
            Inline::Str("Emoji:".to_string()),
            Inline::Space,
        ...
        vec![Inline::Strong(vec![
            ...
            Inline::Str("Unicode:".to_string()),
            Inline::Space,
            Inline::Str("é".to_string()),
            Inline::Space,
            Inline::Str("è".to_string()),
            Inline::Space,
            Inline::Str("ü".to_string()),
            Inline::Space,
            Inline::Str("ö".to_string()),
            Inline::Space,
            Inline::Str("ñ".to_string()),
        ])],
    ];
    ...
    for (i, original_pandoc) in unicode_tests.iter().enumerate() {
        ...
        assert_eq!(
            original_pandoc, &roundtrip_pandoc,
            "Unicode roundtrip conversion failed for case {}",
            i
        );
    }
}
    ...
    for (i, original_pandoc) in edge_cases.iter().enumerate() {
        ...
        if original_pandoc.is_empty() {
            ...
            assert_eq!(
                ...
                original_pandoc.len(),
                "Number of elements not preserved in case {}",
                i
            );
        } else if i == 3 {
            ...
            assert_eq!(
                original_pandoc, &roundtrip_pandoc,
                "Edge case roundtrip failed for case {}",
                i
            );
        }
    }
